...
const RoboticsWorkshopPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Insert into contact_submissions table (no auth required for now)
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          email,
          phone,
          message: `Workshop Registration: ${WORKSHOP_SLUG}`,
        });
        ...
        <div className="relative container pt-12 pb-16 lg:pt-16 lg:pb-20">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl text-slate-700 font-medium leading-relaxed">
                  Join <span className="font-bold text-blue-600">200+ innovators</span> who've already built autonomous robots.
                  Whether you're a <span className="font-semibold text-purple-600">complete beginner</span> or an <span className="font-semibold text-indigo-600">engineering student</span>,
                  you'll walk away with a working robot that senses, thinks, and moves like advanced robotics systems.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-bold text-blue-800">Hardware-First Approach</span>
                    </div>
                    <p className="text-sm text-blue-700">Learn robotics from the ground up - sensors, motors, microcontrollers, and real-world integration.</p>
                  </div>
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-200">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-2xl">🤖</span>
                      <span className="font-bold text-purple-800">Autonomous Systems</span>
                    </div>
                    <p className="text-sm text-purple-700">Build robots that navigate, avoid obstacles, and make decisions using computer vision and AI.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-slate-900">Working Autonomous Robot</div>
                        <div className="text-sm text-slate-600">Complete robot that senses, navigates, and operates independently</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">Robot Builder Kit</div>
                        <div className="text-sm text-slate-600">Professional-grade hardware components and sensors</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">Robotics Software Suite</div>
                        <div className="text-sm text-slate-600">Complete development environment with simulation tools</div>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">Computer Vision System</div>
                        <div className="text-sm text-slate-600">Object detection and tracking capabilities</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">IoT Integration Module</div>
                        <div className="text-sm text-slate-600">Cloud connectivity and remote monitoring features</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">Robotics Blueprints</div>
                        <div className="text-sm text-slate-600">Templates for building custom robotic systems</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                  <button
                    ...
                    disabled={hasEnded}
                  >
                    {hasEnded ? "Workshop Ended" : "🚀 Secure Your Spot Now - ₹399"}
                  </button>
                ...
                <div className="text-center bg-gradient-to-r from-purple-50 via-blue-50 to-indigo-50 rounded-xl p-4 border border-purple-200 shadow-lg">
                  ...
                  <p className="text-sm text-purple-700">
                    Robotics skills are in massive demand. Companies pay ₹8-15 LPA for robotics developers. Start building your portfolio today!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:sticky lg:top-24 space-y-6">
              ...
              <section className="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 py-10 lg:py-14 relative overflow-hidden rounded-3xl border border-slate-200 shadow-xl">
                ...
                <div className="container relative px-6">
                  <div className="space-y-8">
                    <div className="text-center">
                      ...
                      <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 mb-3">Fullstackverse Robotics Delivery Team</h2>
                      <p className="text-slate-600 text-sm lg:text-base max-w-2xl mx-auto">
                        Your instructors are seasoned robotics engineers, embedded developers, and automation coaches who deploy autonomous systems for manufacturing, logistics, and research labs worldwide.
                      </p>
                    </div>
                      ...
                      {[
                        {
                          ...
                          description: "Design sensor stacks, control loops, and motion strategies that keep hardware stable in real environments.",
                        },
                        {
                          title: "Embedded Software Leads",
                          description: "Program microcontrollers, ROS pipelines, and vision modules that make your robot think independently.",
                        },
                        {
                          title: "Automation Strategists",
                          description: "Translate business problems into robotic workflows, safety protocols, and ROI models you can adopt instantly.",
                        },
                        {
                          title: "AI & Vision Specialists",
                          description: "Train perception models, build navigation maps, and fine-tune autonomy behaviour for dynamic terrains.",
                        },
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-4 lg:p-6 rounded-2xl border border-indigo-100 text-center">
                      <h3 className="text-lg font-semibold text-slate-900 mb-2">What This Means for You</h3>
                      <p className="text-sm text-slate-700">
                        You build alongside practitioners delivering real robots, so every template, wiring diagram, and firmware example is production-tested and ready to adopt.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Deployment Guides */}
            <div className="group rounded-lg bg-gradient-to-br from-green-400/20 to-emerald-500/20 backdrop-blur-sm border border-green-400/30 p-4 hover:bg-green-400/30 transition-all duration-300 hover:scale-105">
              <div className="text-center">
                <div className="text-3xl mb-2">🚀</div>
                <div className="text-xl font-bold text-slate-900">Complete</div>
                <div className="text-base text-slate-700 leading-tight">Deployment Guides</div>
              </div>
            </div>

            {/* Premium Certificate - Enhanced */}
            <div className="group rounded-xl bg-gradient-to-br from-yellow-400/25 to-orange-500/25 backdrop-blur-sm border-2 border-yellow-400/40 p-4 hover:bg-yellow-400/35 transition-all duration-300 hover:scale-105 shadow-lg">
              <div className="text-center">
            ...
            {/* Autonomous Control */}
            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-emerald-500/20 to-green-500/20 border border-emerald-400/30 p-4">
              <div className="text-3xl">🧠</div>
              <div>
                <div className="text-lg font-bold text-slate-900">Autonomous Control</div>
                <div className="text-sm text-slate-700">Advanced robotics algorithms</div>
              </div>
            </div>
          </div>

          {/* Robotics Features - Moved Out */}
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/30 p-3">
              <div className="text-2xl">🎯</div>
              <div>
                <div className="text-base font-bold text-slate-900">Hardware Integration</div>
                <div className="text-sm text-slate-600">Connect sensors and actuators</div>
              </div>
            </div>

            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 p-3">
              <div className="text-2xl">👁️</div>
              <div>
                <div className="text-base font-bold text-slate-900">Computer Vision</div>
                <div className="text-sm text-slate-600">Object detection and tracking</div>
              </div>
            </div>

            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-400/30 p-3">
              <div className="text-2xl">🚀</div>
              <div>
                <div className="text-base font-bold text-slate-900">Real-World Deployment</div>
                <div className="text-sm text-slate-600">Build robots that work in practice</div>
              </div>
            </div>

            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-teal-500/20 to-green-500/20 border border-teal-400/30 p-3">
              <div className="text-2xl">👥</div>
              <div>
                <div className="text-base font-bold text-slate-900">Robotics Builder Community</div>
                <div className="text-sm text-slate-600">Connect with 500+ builders</div>
              </div>
            </div>

            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-400/30 p-3">
              <div className="text-2xl">📞</div>
              <div>
                <div className="text-base font-bold text-slate-900">30-Day Expert Support</div>
                <div className="text-sm text-slate-600">Personal robotics guidance</div>
              </div>
            </div>

            <div className="flex items-center gap-3 rounded-lg bg-gradient-to-r from-yellow-500/20 to-amber-500/20 border border-yellow-400/30 p-3">
              <div className="text-2xl">⚡</div>
              <div>
                <div className="text-base font-bold text-slate-900">Build Your First Robot Today</div>
                <div className="text-sm text-slate-600">Complete guidance included</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl lg:text-5xl font-black text-white mb-4 leading-tight">
                What Our <span className="text-transparent bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text">Robot Builders</span> Say
              </h2>
      ...
      <section className="bg-white/80 border-y border-slate-100 py-10 lg:py-14">
        <div className="container">
          ...
          <p className="text-sm text-slate-600 mb-6 max-w-2xl">
            A comprehensive, hands-on guide to designing, building,
            and programming autonomous robots — from basic electronics to advanced
            AI-powered systems used by Tesla, Boston Dynamics, and industrial automation.
          </p>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="text-sm text-slate-600 mb-4">
              This workshop is designed for innovators, engineers, and students who want to
              build real autonomous robots, not just theory or simulations.
            </p>
            <ul className="space-y-2 text-sm text-slate-700">
              <li>• Engineering students and robotics enthusiasts</li>
              <li>• Electronics and embedded systems engineers</li>
              <li>• Product designers exploring hardware innovation</li>
              <li>• Entrepreneurs building robotics startups</li>
              <li>• Professionals transitioning to robotics careers</li>
              <li>• Anyone passionate about autonomous systems and AI</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-slate-900 mb-3">Day 1: Hardware & Control Systems</h3>
                <ol className="space-y-2 text-sm text-slate-700">
                  <li>• Introduction to Robotics & Electronics (2 hours)</li>
                  <li>• Microcontrollers: Arduino & Raspberry Pi (3 hours)</li>
                  <li>• Sensors & Actuators Workshop (3 hours)</li>
                  <li>• Motor Control & PWM (2 hours)</li>
                </ol>
              </div>
              <div>
                <h3 className="font-semibold text-slate-900 mb-3">Day 2: Autonomous Systems & AI</h3>
                <ol className="space-y-2 text-sm text-slate-700">
                  <li>• Computer Vision with OpenCV (3 hours)</li>
                  <li>• Path Planning & Navigation (2 hours)</li>
                  <li>• IoT Integration & Remote Control (2 hours)</li>
                  <li>• Final Project & Presentation (3 hours)</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="card bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 p-6">
                ...
                <p className="text-slate-700 mb-4">
                  During the workshop, you get access to fully built, deployable SaaS products like:
                </p>
                <ul className="list-disc list-inside text-slate-700 space-y-1">
                  <li>CRM systems</li>
                  <li>Billing apps</li>
              ...
              <div className="card bg-gradient-to-r from-slate-50 to-gray-50 border border-slate-200 p-6">
                ...
                <ul className="list-disc list-inside text-slate-700 space-y-1">
                  <li>✔ Working autonomous robots</li>
                  <li>✔ Complete hardware kits</li>
                  <li>✔ Source code for all projects</li>
                  <li>✔ Computer vision systems</li>
                  <li>✔ IoT monitoring dashboards</li>
        ...
        <div className="container relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              Earn Your Robotics Builder Certification
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              Complete the workshop and receive an industry-recognized certificate that validates your robotics building skills
            </p>
          </div>
                ...
                <div className="relative text-center space-y-6">
                  ...
                  <div className="flex justify-between items-end pt-6">
                    <div className="text-left">
                      ...
                      <div className="text-sm text-slate-600">Authorized Signatory</div>
                      <div className="text-xs text-slate-500">Fullstackverse Team</div>
                    </div>
      ...
      <section className="container py-10 lg:py-14">
        ...
        <div className="mb-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl">
          <h3 className="text-lg font-semibold text-slate-900 mb-3 flex items-center gap-2">
            💰 Workshop Pricing & Value
          </h3>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-slate-600">Workshop Fee:</span>
                <span className="font-bold text-slate-900">₹2,999</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Hardware Kit:</span>
                <span className="font-bold text-slate-900">₹5,000 worth</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-slate-900">2 Days</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                disabled={hasEnded}
              >
                {hasEnded ? "Workshop Ended" : "Register Now - ₹2,999"}
              </button>
            </div>
          </div>
        </div>
...
export default RoboticsWorkshopPage;
