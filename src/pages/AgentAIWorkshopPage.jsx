      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container pt-12 pb-16 lg:pt-16 lg:pb-20">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">25+ Website Templates</div>
                    ...
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">12+ SaaS Applications</div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">12+ Web Apps</div>
                    ...
                    <div className="flex items-start gap-3">
                      <span className="text-emerald-500 text-xl mt-0.5">✓</span>
                      <div>
                        <div className="font-semibold text-slate-900">12+ Mobile Apps</div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center bg-gradient-to-r from-purple-50 via-blue-50 to-indigo-50 rounded-xl p-4 border border-purple-200 shadow-lg">
                  <div className="flex items-center justify-center gap-2 text-purple-800 font-bold text-lg mb-2">
                    ...
                    <span>SKILLS WORTH ₹10 LAKHS+</span>
                  </div>
                  <div className="text-purple-700 font-semibold text-sm mb-1">
                    Transform Your Career with AI Agent Expertise
                  </div>
            ...
            {/* Workshop Offerings Creative */}
            <div className="relative h-full flex items-center">
              <div className="relative w-full h-full">
                {/* Main container with gradient background */}
                <div className="relative h-full rounded-3xl bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 p-5 shadow-2xl shadow-blue-500/30 overflow-hidden flex flex-col">
                  ...
                  <div className="absolute -bottom-10 -left-10 h-24 w-24 rounded-full bg-yellow-400/20 blur-lg animate-bounce" style={{animationDuration: '4s'}} />
                  ...
                  <div className="relative text-center mb-3">
                    ...
                    <h3 className="text-6xl font-black text-white mb-1 leading-tight">
                  ...
                  <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-1.5 mb-3 flex-1">
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-100 leading-tight">AI Agent Templates</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-100 leading-tight">Chatbot Blueprints</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-100 leading-tight">Automation Scripts</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-100 leading-tight">API Integrations</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-100 leading-tight">No-Code Builders</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-100 leading-tight">Website Templates</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        <div className="text-3xl mb-0.5">💻</div>
                        <div className="text-lg font-bold text-white">12+</div>
                        <div className="text-sm text-blue-100 leading-tight">Web Apps</div>
                      </div>
                    </div>
                    ...
                    <div className="group rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 p-2 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <div className="text-center">
                        <div className="text-3xl mb-0.5">📱</div>
                        <div className="text-lg font-bold text-white">12+</div>
                        <div className="text-sm text-blue-100 leading-tight">Mobile Apps</div>
                      </div>
                    </div>
        ...
        <div className="container relative">
          <div className="max-w-6xl mx-auto space-y-12">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-slate-900 mb-3">Fullstackverse Expert Delivery Team</h2>
              <p className="text-slate-600 max-w-3xl mx-auto">
                Learn from a battle-tested product team of senior AI engineers, solution architects, and automation strategists who deploy agent-first systems for global clients every week.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  title: "AI Systems Architects",
                  description: "Design the cognitive workflows, guardrails, and orchestration patterns your agents will use in production.",
                },
                {
                  title: "Automation Engineers",
                  description: "Ship multi-channel integrations, no-code accelerators, and deployment pipelines so you can launch fast.",
                },
                {
                  title: "Product Strategists",
                  description: "Map real business goals to agent capabilities, pricing, and monetisation models that drive revenue.",
                },
                {
                  title: "Data & Prompt Leads",
                  description: "Craft high-signal data sets, prompt frameworks, and evaluation loops that keep agents reliable.",
                },
                {
                  title: "Customer Success Coaches",
                  description: "Support you post-session with community Q&A, implementation checklists, and accountability sprints.",
                },
                {
                  title: "Security & Compliance Advisors",
                  description: "Share enterprise-ready patterns for audit trails, policy enforcement, and responsible AI operations.",
                },
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-3xl border border-indigo-100 text-center">
              ...
              <p className="text-sm text-slate-700 max-w-3xl mx-auto">
                Every framework, worksheet, and demo in the workshop is distilled from live client deliveries, so you leave with a proven playbook instead of theory.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="text-sm text-slate-600 mb-4">
              This workshop is ideal for builders and decision-makers who want to
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="card bg-gradient-to-r from-slate-50 to-gray-50 border border-slate-200 p-6">
                ...
                <ul className="list-disc list-inside text-slate-700 space-y-1">
                  <li>✔ 25+ Website Templates</li>
                  <li>✔ 12+ SaaS Applications</li>
                  <li>✔ 12+ Web Apps (Source Code)</li>
                  <li>✔ 12+ Mobile Apps (Source Code)</li>
...
export default AgentAIWorkshopPage;
